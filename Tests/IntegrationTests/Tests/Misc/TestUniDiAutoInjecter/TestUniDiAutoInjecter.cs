...
{
    public class TestUniDiAutoInjecter : UniDiIntegrationTestFixture
    {
        GameObject GetPrefab(string name)
        {
            return FixtureUtil.GetPrefab("TestUniDiAutoInjecter/{0}".Fmt(name));
        }
        ...
        public IEnumerator TestAddComponent()
        {
            ...
            bar.gameObject.AddComponent<UniDiAutoInjecter>();
