...
namespace UniDi.Internal
{
    ...
    public static class SceneParentAutomaticLoader
    {
        ...
        public static void ValidateMultiSceneSetupAndLoadDefaultSceneParents()
        {
            ...
            var sceneInfos = GetLoadedUniDiSceneInfos();
        ...
        static LoadedSceneInfo CreateLoadedSceneInfo(Scene scene)
        {
            ...
            Assert.IsNotNull(info, "Expected scene '{0}' to be a UniDi scene", scene.name);
            return info;
        }
        ...
        static List<LoadedSceneInfo> GetLoadedUniDiSceneInfos()
        {
