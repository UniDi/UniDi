...
namespace UniDi
{
    public class SceneContext : RunnableContext
    {
...
#if UNITY_EDITOR
            using (ProfileBlock.Start("UniDi.SceneContext.Install"))
#endif
            {
                Install();
            }
...
#if UNITY_EDITOR
            using (ProfileBlock.Start("UniDi.SceneContext.Resolve"))
#endif
            {
                Resolve();
            }
        ...
        IEnumerable<DiContainer> GetParentContainers()
        {
            ...
            if (parentContractNames.IsEmpty())
            {
                if (ParentContainers != null)
                {
                    ...
                    // between scenes via UniDiSceneLoader
        ...
        void InstallBindings(List<MonoBehaviour> injectableMonoBehaviours)
        {
            ...
            _container.Bind<UniDiSceneLoader>().AsSingle();
