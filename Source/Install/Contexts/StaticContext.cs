...
namespace UniDi
{
    // For some platforms, it's desirable to be able to add dependencies to UniDi before
    // Unity even starts up (eg. WSA as described here https://github.com/svermeulen/UniDi/issues/118)
