...
namespace UniDi
{
    public abstract class UniDiIntegrationTestFixture
    {
        ...
        protected DiContainer Container
        {
            get
            {
                Assert.That(_hasStartedInstall,
                    "Must call PreInstall() before accessing UniDiIntegrationTestFixture.Container!");
        ...
        protected SceneContext SceneContext
        {
            ...
            {
                Assert.That(_hasStartedInstall,
                    "Must call PreInstall() before accessing UniDiIntegrationTestFixture.SceneContext!");
