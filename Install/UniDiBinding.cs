...
namespace UniDi
{
    public class UniDiBinding : MonoBehaviour
    {
        [Tooltip("The component to add to the UniDi container")]
        [SerializeField]
        ...
        [Tooltip("When set, this will bind the given components to the SceneContext.  It can be used as a shortcut to explicitly dragging the SceneContext into the Context field.  This is useful when using UniDiBinding inside GameObjectContext.  If your UniDiBinding is for a component that is not underneath GameObjectContext then it is not necessary to check this")]
        [SerializeField]
