        ...
        public InstantiateCallbackConditionCopyNonLazyBinder WithArguments(object[] args)
        {
            ...
            for (int i = 0; i < args.Length; i++)
            {
                ...
                Assert.IsNotNull(arg,
                    "Cannot include null values when creating a UniDi argument list because UniDi has no way of deducing the type from a null value.  If you want to allow null, use the Explicit form.");
