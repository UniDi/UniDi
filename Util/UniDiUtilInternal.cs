...
{
    public static class UniDiUtilInternal
    {
#if UNITY_EDITOR
        ...
        // need to use UniDiStateMachineBehaviourAutoInjecter to do the injection at that
        // time for us
        public static void AddStateMachineBehaviourAutoInjectersUnderGameObject(GameObject root)
        {
...
#endif
            {
                ...
                {
                    if (animator.gameObject.GetComponent<UniDiStateMachineBehaviourAutoInjecter>() == null)
                    {
                        animator.gameObject.AddComponent<UniDiStateMachineBehaviourAutoInjecter>();
                    }
                }
            }
        }
        ...
        public static Transform GetOrCreateInactivePrefabParent()
        {
            ...
            {
                var go = new GameObject("UniDiUtilInternal_PrefabParent");
