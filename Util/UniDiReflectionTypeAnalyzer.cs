    ...
    public static class ReflectionTypeAnalyzer
    {
        ...
        static ConstructorInfo TryGetInjectConstructor(Type type)
        {
            ...
            if (constructors.HasMoreThan(1))
            {
                ...
                // but is probably the best trade-off since it allows UniDi to be more compatible
                // with libraries that don't depend on UniDi at all
                // Discussion here - https://github.com/svermeulen/UniDi/issues/416
