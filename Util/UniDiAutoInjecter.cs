...
namespace UniDi
{
    public class UniDiAutoInjecter : MonoBehaviour
    {
        [SerializeField]
        ...
        public void Construct()
        {
            if (!_hasInjected)
            {
                throw Assert.CreateException(
                    "UniDiAutoInjecter was injected!  Do not use UniDiAutoInjecter for objects that are instantiated through UniDi or which exist in the initial scene hierarchy");
            }
        }
